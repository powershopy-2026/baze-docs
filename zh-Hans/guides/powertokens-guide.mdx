        ...
        <div class="step-content">
          ...
          <table class="styled-table">
            ...
            <tbody>
              ...
              <tr><td><strong>URL</strong></td><td><code style="background:#f0fdf4;padding:2px 6px;border-radius:4px;font-size:.82rem">https://baze-api.powerbuyin.top/v1/chat/completions</code></td></tr>
