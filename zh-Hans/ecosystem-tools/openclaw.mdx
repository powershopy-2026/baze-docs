...
| Claude/Anthropic 路径模型 | `anthropic-messages` | `https://baze-api.powerbuyin.top` | 智谱、MiniMax、Qwen 推荐模型 |
| OpenAI-compatible 优先模型 | `openai-completions` | `https://baze-api.powerbuyin.top/v1` | BytePlus、DeepSeek 等不建议走 Anthropic provider 的文本模型 |
