...
| --- | --- | --- | --- |
| Use OpenAI-compatible text models | OpenAI Compatible or OpenAI (Compatible) | `https://baze-api.powerbuyin.top/v1` | Text models that support `/v1/chat/completions` |
| Use Anthropic-path models | Anthropic with custom base URL | `https://baze-api.powerbuyin.top/v1` | Recommended Zhipu, MiniMax, and Qwen models |
| Use OpenAI-compatible preferred models | OpenAI Compatible | `https://baze-api.powerbuyin.top/v1` | BytePlus, DeepSeek, and other text models not recommended for Anthropic provider |
...
| **Base URL** | `https://baze-api.powerbuyin.top/v1` |
...
| **Custom base URL** | `https://baze-api.powerbuyin.top/v1` |
| **Anthropic API Key** | Your `powertokens platform` API key |
| **Model** | One of the recommended model IDs below |

Kilo Code's Anthropic provider appends `/messages` to **Custom base URL**. Set the field to the version path `https://baze-api.powerbuyin.top/v1` so the final request reaches the platform's `/v1/messages` endpoint.
...
| Upstream provider | Models |
| --- | --- |
| BytePlus | `deepseek-v3-2-251201`, `gpt-oss-120b-250805`, `seed-1-6-250915`, `seed-1-6-flash-250715`, `seed-1-8-251228`, `seed-2-0-lite-260228`, `seed-2-0-mini-260215`, `seed-2-0-pro-260328` |
