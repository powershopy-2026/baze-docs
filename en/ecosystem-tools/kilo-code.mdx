...
| Use Anthropic-path models | Anthropic with custom base URL | `https://baze-api.powerbuyin.top/v1` | Recommended Zhipu, MiniMax, Qwen, BytePlus DeepSeek, and re-validated Seed models that support Messages |
| Use OpenAI-compatible preferred models | OpenAI Compatible | `https://baze-api.powerbuyin.top/v1` | Text models whose upstream provider does not support `/v1/messages`, such as `seed-1-6-flash-250715` |
