...
| Anthropic Messages verification | Use `api_mode: anthropic_messages` only after your Hermes version is confirmed to request `/v1/messages` | `https://baze-api.powerbuyin.top` | Recommended Zhipu, MiniMax, and Qwen models |
| OpenAI-compatible preferred models | Custom endpoint | `https://baze-api.powerbuyin.top/v1` | BytePlus, DeepSeek, and other text models not recommended for Anthropic provider |
