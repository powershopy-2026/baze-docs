...
| Model | Reason |
| --- | --- |
| `deepseek-v3.2` | Not recommended as the default for streaming-dependent Claude Code workflows |
| `deepseek-v3-2-251201`, `gpt-oss-120b-250805`, Seed models | Prefer an OpenAI-compatible provider; validate Claude Code separately |
