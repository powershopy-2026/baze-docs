...
| --- | --- | --- | --- |
| OpenAI-compatible text models | `openai-completions` | `https://baze-api.powerbuyin.top/v1` | Text models that support `/v1/chat/completions` |
| Anthropic-path models | `anthropic-messages` | `https://baze-api.powerbuyin.top` | Recommended Zhipu, MiniMax, Qwen, BytePlus DeepSeek, and re-validated Seed models that support Messages |
| OpenAI-compatible preferred models | `openai-completions` | `https://baze-api.powerbuyin.top/v1` | Text models whose upstream provider does not support `/v1/messages`, such as `seed-1-6-flash-250715` |
