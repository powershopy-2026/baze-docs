...
| Anthropic-path models | `anthropic-messages` | `https://baze-api.powerbuyin.top` | Recommended Zhipu, MiniMax, and Qwen models |
| OpenAI-compatible preferred models | `openai-completions` | `https://baze-api.powerbuyin.top/v1` | BytePlus, DeepSeek, and other text models not recommended for Anthropic provider |
