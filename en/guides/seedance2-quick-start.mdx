...
2. **Get an API Key**: Go to the [API Keys management page](https://baze-api.powerbuyin.top-keys), create a new key, copy and store it securely
...
|---|---|---|
| Base URL | `https://baze-api.powerbuyin.top` (same) | `https://baze-api.powerbuyin.top` (same) |
