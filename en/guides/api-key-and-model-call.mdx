...
![PowerTokens API Keys page](/images/guides/powertokens-quickstart/en/api-keys.jpg)

Click **Create new key** in the upper-right corner.

![Create a PowerTokens API key](/images/guides/powertokens-quickstart/en/create-api-key.jpg)
...
![PowerTokens model catalog](/images/guides/powertokens-quickstart/en/models.jpg)
...
```bash
curl --request POST \
  --url https://baze-api.powerbuyin.top/v1/chat/completions \
...
OpenAI SDK Integration Example (Python)<br />
 To use the official OpenAI SDK, configure the base_url as https://baze-api.powerbuyin.top/v1 and use your API Key.
...
client = OpenAI(
    api_key="YOUR_KEY",
    base_url="https://baze-api.powerbuyin.top/v1",
)

resp = client.chat.completions.create(
    model="MiniMax-M3",
    messages=[{"role": "user", "content": "Describe Paris in one sentence."}],
)
...
![PowerTokens Playground](/images/guides/powertokens-quickstart/en/playground.jpg)
